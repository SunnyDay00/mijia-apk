...
6. 打开“常驻通知，保持电量监听服务运行”，让 App 持续显示当前电量并保持前台服务。
7. 打开“启用阈值自动开关插座”，按阈值自动控制插座。
8. 在“后台权限”区域依次打开后台运行、自启动、应用设置，允许通知、后台运行和自启动。

Android 后台会限制长期任务。启用自动控制后，系统会显示前台服务通知；建议在系统电池设置里允许本 App 后台运行。

APK 可以读取手机电量：Android 的电池状态由系统广播提供，App 在首页和前台通知中显示当前电量；启用自动控制后也使用同一电量来源判断是否开关插座。
